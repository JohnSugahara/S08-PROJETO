...
O projeto tem como objetivo testar diferentes funcionalidades da estrutura nativa `Vector2` da Godot, utilizando testes automatizados executáveis por linha de comando.
